class DustBin{
   constructor(x,y,width,height){
      ...
      this.bodyl = Bodies.rectangle((x-(width/2)), (y-(height*2)),height,options);
   ...
   display(){
       ...
       rect((this.bodyb.position.x - (this.bodyb.width/2)),(this.bodyb.position.y-(this.bodyb.height*2)),this.bodyb.height);
       rect((this.bodyb.position.x+ (this.bodyb.width/2)),(this.bodyb.position.y-(this.bodyb.height*2)),this.bodyb.height);
   }
